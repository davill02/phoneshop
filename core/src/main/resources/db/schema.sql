...
create table order2phone(
    ...
    UNIQUE (orderId,phoneId),
    CONSTRAINT FK_order2phone_phoneId FOREIGN KEY (phoneId) REFERENCES phones(id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT FK_order2phone_orderId FOREIGN KEY (orderId) REFERENCES orders(id) ON DELETE CASCADE ON UPDATE CASCADE
);